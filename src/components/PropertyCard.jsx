    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-4 text-sm text-gray-600 mb-3">
          ...
          <span className="flex items-center gap-1">📐 {property.size}m²</span>
        </div>
        ...
        <div className="flex justify-between items-center pt-3 border-t">
          <div className="font-bold text-lg text-primary">{property.price}/month</div>
          <Link 
            to={`/property/${property.id}`}
            className="bg-dark text-white px-4 py-2 rounded text-sm hover:bg-opacity-90 transition"
          >
            View Details
          </Link>
        </div>
